function plot_inner_loop_errors(Y, states)
    ...
    grid on;
    figure(1);
    subplot(3,1,1);plot(states(:,1),eulerStates(:,1)*r2d, 'LineWidth', 1.5);xlabel('time', 'FontSize', 20);ylabel('\phi', 'FontSize', 20);
    ...
    subplot(3,1,2);plot(states(:,1),eulerStates(:,2)*r2d, 'LineWidth', 1.5);xlabel('time', 'FontSize', 20);ylabel('\theta', 'FontSize', 20);
    grid on; 
    set(gca,'fontsize',12,'FontWeight','bold');
    hold on;
    ...
    hold off;
    legend('actual', 'desired');
    subplot(3,1,3);plot(states(:,1),eulerStates(:,3)*r2d, 'LineWidth', 1.5);xlabel('time', 'FontSize', 20);ylabel('\psi', 'FontSize', 20);
    grid on; 
    set(gca,'fontsize',12,'FontWeight','bold');
    hold on;
